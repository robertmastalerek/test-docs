...
The full list of supported configuration parameters can be found [here](/user-guide/latest/user-guide/spring-boot-integration/configuration/#camunda-engine-properties).
